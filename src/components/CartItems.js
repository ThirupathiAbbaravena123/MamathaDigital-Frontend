        ...
        <div className='d-flex row col-3'>
            <div className='col border mt-5' style={{backgroundColor:"#f8f3f2",textAlign:"center"}}>
                ...
                <div className='row mt-3 mb-2'>
                    ...
                    <p className='col-4 ' style={{fontWeight:"bolder",color:'green'}}>&#8377; 200</p>
                </div>
                <hr />
                <div className='row mt-3 mb-2'>
            ...
            <div>
                <button  className='btn btn-danger col-8 mt-5 ms-5' onClick={() => setShowPopup(true)}>Proceed & Pay</button>
